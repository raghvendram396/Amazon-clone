    ...
    return (
        <div className="Home">
          ...
          <div className="Products">
           ...
           <div className="items">
           <Product id={3} title="Raysx Smart Watch A1 Black colour 4G watch Smartwatch  (Black Strap, Free)" image="https://rukminim1.flixcart.com/image/416/416/jy0frm80/smartwatch/7/7/d/a1-black-smartwatch-bsw-12-cyxus-4g-original-imafgb8b4uec97fb.jpeg?q=70" price={2599} rating={4}></Product>
           ...
           <div className="items">
           <Product id={6} title="Samsung UN55RU7300FXZA Curved 55-Inch 4K UHD 7 Series Ultra HD Smart TV with HDR and Alexa Compatibility" image="https://images-na.ssl-images-amazon.com/images/I/91o08DsRplL._AC_SX355_.jpg" price={204878} rating={5}></Product>
           </div>
          </div>
        </div>
    )
